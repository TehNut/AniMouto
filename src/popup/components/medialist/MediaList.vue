    ...
    methods: {
      ...
      parseMediaList(response) {
        ...
        if (data.anime.mediaList.length > 0) {
          ...
          res.airing.list = res.airing.list.sort((o1, o2) => o1.media.nextAiringEpisode && o2.media.nextAiringEpisode ? o1.media.nextAiringEpisode.timeUntilAiring - o2.media.nextAiringEpisode.timeUntilAiring : 1);
